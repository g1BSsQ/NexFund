import {
  ...
  export async function contributeother(wallet: BrowserWallet, admin: string, assets: any, amount: number, minimum: number, name: string, contributeSelection: number) {
    try {
