import {
  ...
  export async function contribute(other: nwallet: BrowserWallet, admin: string, assets: any, amount: number, minimum: number, name: string, contributeSelection: number) {
    try {
