...
async function exportMoney(txHash: string, wallet: BrowserWallet, walletAddr: string, admin: string, name: string, minimum: number, amount) {
    ...
    const datum = mConStr0([amount, pubkeyAdmin, pubkeyAdmin ])
